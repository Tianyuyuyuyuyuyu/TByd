...
using System.Text;
using TBydFramework.Log4Net.Editor.LogReceiver;
using TBydFramework.Log4Net.Runtime;
using TBydFramework.Runtime.Log;
using UnityEditor;
using UnityEngine;
using LocationInfo = TBydFramework.Log4Net.Runtime.LocationInfo;

namespace TBydFramework.Log4Net.Editor.ViewModels
{
    [Serializable]
    public class ConsoleVM
    {
        ...
        private const string LEVEL_MASK_KEY = "X::LOG::LOG4NET::LEVEL";
        private const string COLUMN_MASK_KEY = "X::LOG::LOG4NET::COLUMN";
        private const string COLLAPSE_SHOW_KEY = "X::LOG::LOG4NET::COLLAPSE";
        private const string PORT_KEY = "X::LOG::LOG4NET::PORT";
        private const string PLAY_STATE_KEY = "X::LOG::LOG4NET::PLAY_STATE";
        private const string LAST_SAVE_DIR_KEY = "X::LOG::LOG4NET::LAST_DIR";
