...
namespace TByd.PackageCreator.Tests.Editor.Utils
{
    ...
    public class AssetDatabaseUtilsTests
    {
        ...
        public void TearDown()
        {
            ...
            string metaFilePath = _testFolderPath + ".meta";
        ...
        {
            // 执行
            string result = AssetDatabaseUtils.AbsolutePathToAssetPath(_testFilePath);
        ...
        {
            // 执行
            string result = AssetDatabaseUtils.AbsolutePathToAssetPath("C:/InvalidPath/test.asset");
        ...
        {
            // 执行
            string result = AssetDatabaseUtils.AssetPathToAbsolutePath(_testFileAssetPath);
        ...
        {
            // 执行
            string result = AssetDatabaseUtils.AssetPathToAbsolutePath("Assets/NonExistent/test.asset");
        ...
        {
            // 准备
            string testSubFolder = _testFolderAssetPath + "/SubFolder";
            string testSubFolderPath = Path.Combine(_testFolderPath, "SubFolder");
            ...
            bool result = AssetDatabaseUtils.EnsureDirectoryExists(testSubFolder);
        ...
        public void EnsureDirectoryExists_ReturnsTrue_WhenDirectoryAlreadyExists()
        {
            ...
            // 执行
            bool result = AssetDatabaseUtils.EnsureDirectoryExists(_testFolderAssetPath);
        ...
        {
            // 准备 - 创建测试资产
            TestScriptableObject testAsset = ScriptableObject.CreateInstance<TestScriptableObject>();
            ...
            bool result = AssetDatabaseUtils.DeleteAsset(_testFileAssetPath);
        ...
        {
            // 准备
            string nonExistentAssetPath = _testFolderAssetPath + "/nonexistent.asset";
            // 更新期望的日志消息，使其匹配实际输出
            LogAssert.Expect(LogType.Warning, $"删除资源失败: {nonExistentAssetPath}");

            // 执行
            bool result = AssetDatabaseUtils.DeleteAsset(nonExistentAssetPath);
        ...
        public void CreateAsset_CreatesAndSavesAsset()
        {
            ...
            bool result = AssetDatabaseUtils.CreateAsset(testAsset, _testFileAssetPath);
            ...
            // 验证资产可以被加载
            TestScriptableObject loadedAsset = AssetDatabase.LoadAssetAtPath<TestScriptableObject>(_testFileAssetPath);
        ...
        public void LoadAsset_ReturnsNull_WhenAssetDoesNotExist()
        {
            ...
            // 执行
            TestScriptableObject loadedAsset = AssetDatabaseUtils.LoadAsset<TestScriptableObject>(nonExistentAssetPath);
        ...
        {
            // 执行
            List<TestScriptableObject> assets = AssetDatabaseUtils.FindAssets<TestScriptableObject>(_testFolderAssetPath);
