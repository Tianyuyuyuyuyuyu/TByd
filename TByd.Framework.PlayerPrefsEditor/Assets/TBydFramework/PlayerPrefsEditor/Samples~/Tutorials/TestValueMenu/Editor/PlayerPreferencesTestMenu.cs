...
namespace Samples.PlayerPrefsEditor
{
    public class PlayerPrefsTestMenu
    {

        [MenuItem("X/PlayerPrefs Test Values/AddEntry Strings", false, 0)]
        ...
        [MenuItem("X/PlayerPrefs Test Values/AddEntry Int", false, 1)]
        ...
        [MenuItem("X/PlayerPrefs Test Values/AddEntry Float", false, 2)]
        ...
        [MenuItem("X/PlayerPrefs Test Values/AddEntry ValidKeys", false, 20)]
        ...
        [MenuItem("X/PlayerPrefs Test Values/AddEntry Many", false, 21)]
        ...
        [MenuItem("X/PlayerPrefs Test Values/AddEntry Fonts", false, 22)]
        ...
        [MenuItem("X/PlayerPrefs Test Values/DeleteAll", false, 50)]
