...
using TBydFramework.ILRuntime.Runtime.ILRuntime.Adapters;
using TBydFramework.Runtime.Asynchronous;
using TBydFramework.Runtime.Log;
using AppDomain = ILRuntime.Runtime.Enviorment.AppDomain;

namespace TBydFramework.ILRuntime.Runtime.ILRuntime
{
    public static class ILRuntimeEnvironment
    {
        ...
        private static void Initialize()
        {
            lock (syncLock)
            {
                ...
                appdomain.DelegateManager.RegisterMethodDelegate<INotifyPropertyChangedAdapter.Adapter>();
