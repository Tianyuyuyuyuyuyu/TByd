...
namespace Samples.ILRuntime._1._6._7.Demo.LitJson
{
    /// <summary>
    ...
    public class JsonMapper
    {
        ...
        private static void AddArrayMetadata (Type type)
        {
            ...
            if (type is global::ILRuntime.Reflection.ILRuntimeWrapperType)
            {
                var wt = (global::ILRuntime.Reflection.ILRuntimeWrapperType)type;
                if (data.IsArray)
                {
            ...
            foreach (PropertyInfo p_info in type.GetProperties ()) {
                ...
                if (p_info.Name == "Item") {
                    ...
                    if (parameters[0].ParameterType == typeof(string))
                    {
                        if (type is global::ILRuntime.Reflection.ILRuntimeWrapperType)
                        {
                            data.ElementType = ((global::ILRuntime.Reflection.ILRuntimeWrapperType)type).CLRType.GenericArguments[1].Value.ReflectionType;
                        }
                        else
                            data.ElementType = p_info.PropertyType;
                    }
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.Double ||
                ...
                var vt = value_type is global::ILRuntime.Reflection.ILRuntimeWrapperType ? ((global::ILRuntime.Reflection.ILRuntimeWrapperType)value_type).CLRType.TypeForCLR : value_type;

                if (vt.IsAssignableFrom(json_type))
                    return reader.Value;
                if (vt is global::ILRuntime.Reflection.ILRuntimeType && ((global::ILRuntime.Reflection.ILRuntimeType)vt).ILType.IsEnum)
                {
            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                while (true) {
                    ...
                    if (item == null && reader.Token == JsonToken.ArrayEnd)
                        break;
                    var rt = elem_type is global::ILRuntime.Reflection.ILRuntimeWrapperType ? ((global::ILRuntime.Reflection.ILRuntimeWrapperType)elem_type).RealType : elem_type;
                    if (elem_type is global::ILRuntime.Reflection.ILRuntimeType && ((global::ILRuntime.Reflection.ILRuntimeType)elem_type).ILType.IsEnum)
                    {
                        item = (int) item;
                    }
                    else
            ...
            } else if (reader.Token == JsonToken.ObjectStart)
            {
                ...
                if (value_type is global::ILRuntime.Reflection.ILRuntimeType)
                    instance = ((global::ILRuntime.Reflection.ILRuntimeType) value_type).ILType.Instantiate();
                else
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        var rt = t_data.ElementType is global::ILRuntime.Reflection.ILRuntimeWrapperType
                            ? ((global::ILRuntime.Reflection.ILRuntimeWrapperType) t_data.ElementType).RealType
                            : t_data.ElementType;
                        //value 是枚举的情况没处理,毕竟少
                        if (isIntKey)
                        {
                                        ...
                                        int depth)
        {
            ...
            Type obj_type;
            if (obj is global::ILRuntime.Runtime.Intepreter.ILTypeInstance)
            {
                obj_type = ((global::ILRuntime.Runtime.Intepreter.ILTypeInstance)obj).Type.ReflectionType;
            }
            else if(obj is global::ILRuntime.Runtime.Enviorment.CrossBindingAdaptorType)
            {
                obj_type = ((global::ILRuntime.Runtime.Enviorment.CrossBindingAdaptorType)obj).ILInstance.Type.ReflectionType;
            }
            else
        ...
        public unsafe static void RegisterILRuntimeCLRRedirection(global::ILRuntime.Runtime.Enviorment.AppDomain appdomain)
        {
        ...
        {
            global::ILRuntime.Runtime.Enviorment.AppDomain __domain = intp.AppDomain;
