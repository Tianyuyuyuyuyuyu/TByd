...
namespace Samples.ILRuntime._1._6._7.Demo.Scripts.Examples._02_Invocation
{
    public class Invocation : MonoBehaviour
    {
        ...
        void OnHotFixLoaded()
        {
            ...
            //参数类型列表
            List<IType> paramList = new List<global::ILRuntime.CLR.TypeSystem.IType>();
            ...
            UnityEngine.Debug.LogFormat("aaaaaaaaaaaaaaaaaaaaaaaa {0}  {1}", obj.GetType(), (obj is ILTypeInstance));
            ...
            foreach (var a in type.ReflectionType.GetMembers())
            {
                ...
                Debug.LogFormat("memberInfo:{0}  {1}  {2}", a.Name, a.MemberType, a.GetType());
            }


            //Debug.Log("调用成员方法");
            //object value = 20;
            //method = type.GetMethod("Add", 4);
            //using (var ctx = appdomain.BeginInvoke(method))
            //{
            //    ctx.PushObject(obj);
            //    ctx.PushInteger(1.0f);
            //    ctx.PushInteger(2);
            //    ctx.PushInteger(3);
            //    ctx.PushFloat(2.4f);
            //    ctx.Invoke();
            //    float ret = ctx.ReadFloat();
            //    Debug.LogFormat("Add() = {0}",ret);
            //}
