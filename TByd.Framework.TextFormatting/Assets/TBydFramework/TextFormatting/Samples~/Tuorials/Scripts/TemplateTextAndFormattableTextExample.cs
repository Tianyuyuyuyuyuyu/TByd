...
using XFramework.Runtime.Binding.Builder;
using XFramework.Runtime.Contexts;
using XFramework.Runtime.Observables;
using XFramework.Runtime.Services;
using XFramework.TextFormatting.Runtime.Views.UGUI;
...
namespace XFramework.Tutorials
{
    public class TemplateTextAndFormattableTextExample : MonoBehaviour
    {
        ...
        public FormattableText arrayBinding;//也可以使用 ArrayParameters<float>
        ...
        private void Start()
        {
            ...
            //使用AsArray<T>() 获得一个数组然后进行绑定，支持多个类型相同的参数，没有值对象的装箱拆箱，没有字符串拼接，降低GC，使用TMP文本可以完全无GC
