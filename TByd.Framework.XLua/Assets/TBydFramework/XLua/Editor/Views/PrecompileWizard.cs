...
using TBydFramework.XLua.Editor.Compiler;
using UnityEditor;
using UnityEngine;
...
namespace TBydFramework.XLua.Editor.Views
{
    public class PrecompileWizard : ScriptableWizard
    {
        ...
        private const string PATH = "Assets/XFramework/Editor/AppData/XLua/PrecompileSetting.json";
        private const string LUA_EXTENSION_PATTERN = @"((\.lua)|(\.lua\.txt))$";

        [MenuItem("Tools/X/Precompile Wizard for Lua")]
