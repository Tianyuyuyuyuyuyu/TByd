...
namespace XLua.CSObjectWrap
{
    ...
    public class XFrameworkXLuaRuntimeViewsLuaWindowWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TBydFramework.XLua.Runtime.Views.LuaWindow constructor!");
