...
namespace XLua.CSObjectWrap
{
    ...
    public class XFrameworkXLuaRuntimeViewsLuaUIViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaUIView);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TBydFramework.XLua.Runtime.Views.LuaUIView constructor!");
        ...
        static int _m_GetMetatable(RealStatePtr L)
        {
		    try {
                ...
                LuaUIView gen_to_be_invoked = (LuaUIView)translator.FastGetCSObj(L, 1);
