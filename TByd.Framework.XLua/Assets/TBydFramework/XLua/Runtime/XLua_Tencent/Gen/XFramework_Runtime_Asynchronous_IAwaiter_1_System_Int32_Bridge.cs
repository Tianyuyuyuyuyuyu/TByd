...
{
    public class XFrameworkRuntimeAsynchronousIAwaiter_1_SystemInt32_Bridge : LuaBase, TBydFramework.Runtime.Asynchronous.IAwaiter<int>
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new XFrameworkRuntimeAsynchronousIAwaiter_1_SystemInt32_Bridge(reference, luaenv);
		}
		
		public XFrameworkRuntimeAsynchronousIAwaiter_1_SystemInt32_Bridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int TBydFramework.Runtime.Asynchronous.IAwaiter<int>.GetResult()
		{
        ...
        bool TBydFramework.Runtime.Asynchronous.IAwaiter<int>.IsCompleted 
        {
