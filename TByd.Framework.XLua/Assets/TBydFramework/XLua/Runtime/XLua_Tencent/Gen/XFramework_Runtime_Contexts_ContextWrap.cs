...
namespace XLua.CSObjectWrap
{
    ...
    public class XFrameworkRuntimeContextsContextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(TBydFramework.Runtime.Contexts.Context);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new TBydFramework.Runtime.Contexts.Context();
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<TBydFramework.Runtime.Services.IServiceContainer>(L, 2) && translator.Assignable<TBydFramework.Runtime.Contexts.Context>(L, 3))
				{
					...
					TBydFramework.Runtime.Contexts.Context _contextBase = (TBydFramework.Runtime.Contexts.Context)translator.GetObject(L, 3, typeof(TBydFramework.Runtime.Contexts.Context));
					
					var gen_ret = new TBydFramework.Runtime.Contexts.Context(_container, _contextBase);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TBydFramework.Runtime.Contexts.Context constructor!");
        ...
        static int _m_GetApplicationContext_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = TBydFramework.Runtime.Contexts.Context.GetApplicationContext(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetApplicationContext_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    TBydFramework.Runtime.Contexts.ApplicationContext _context = (TBydFramework.Runtime.Contexts.ApplicationContext)translator.GetObject(L, 1, typeof(TBydFramework.Runtime.Contexts.ApplicationContext));
                    
                    TBydFramework.Runtime.Contexts.Context.SetApplicationContext( _context );
		    ...
		    try {
                ...
                
                {
                    string _key = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = TBydFramework.Runtime.Contexts.Context.GetContext( _key );
                        translator.Push(L, gen_ret);
        ...
        static int _m_AddContext_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _key = LuaAPI.lua_tostring(L, 1);
                    TBydFramework.Runtime.Contexts.Context _context = (TBydFramework.Runtime.Contexts.Context)translator.GetObject(L, 2, typeof(TBydFramework.Runtime.Contexts.Context));
                    
                    TBydFramework.Runtime.Contexts.Context.AddContext( _key, _context );
        ...
        static int _m_RemoveContext_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    TBydFramework.Runtime.Contexts.Context.RemoveContext( _key );
        ...
        static int _m_Contains(RealStatePtr L)
        {
		    try {
                ...
                TBydFramework.Runtime.Contexts.Context gen_to_be_invoked = (TBydFramework.Runtime.Contexts.Context)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TBydFramework.Runtime.Contexts.Context.Contains!");
        ...
        static int _m_Get(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TBydFramework.Runtime.Contexts.Context.Get!");
        ...
        static int _m_GetService(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TBydFramework.Runtime.Contexts.Context.GetService!");
