...
{
    public class XFrameworkRuntimeAsynchronousIAwaiterBridge : LuaBase, TBydFramework.Runtime.Asynchronous.IAwaiter
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new XFrameworkRuntimeAsynchronousIAwaiterBridge(reference, luaenv);
		}
		
		public XFrameworkRuntimeAsynchronousIAwaiterBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		void TBydFramework.Runtime.Asynchronous.IAwaiter.GetResult()
		{
        ...
        bool TBydFramework.Runtime.Asynchronous.IAwaiter.IsCompleted 
        {
