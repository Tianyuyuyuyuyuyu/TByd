...
namespace XLua.CSObjectWrap
{
    ...
    public class XFrameworkXLuaRuntimeViewsLuaViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaView);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TBydFramework.XLua.Runtime.Views.LuaView constructor!");
        ...
        static int _m_GetMetatable(RealStatePtr L)
        {
		    try {
                ...
                LuaView gen_to_be_invoked = (LuaView)translator.FastGetCSObj(L, 1);
