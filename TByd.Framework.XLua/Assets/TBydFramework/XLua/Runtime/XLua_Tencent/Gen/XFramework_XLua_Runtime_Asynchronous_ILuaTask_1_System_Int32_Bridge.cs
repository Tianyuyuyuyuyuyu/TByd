...
{
    public class XFrameworkXLuaRuntimeAsynchronousILuaTask_1_SystemInt32_Bridge : LuaBase, ILuaTask<int>
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new XFrameworkXLuaRuntimeAsynchronousILuaTask_1_SystemInt32_Bridge(reference, luaenv);
		}
		
		public XFrameworkXLuaRuntimeAsynchronousILuaTask_1_SystemInt32_Bridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int ILuaTask<int>.GetResult()
		{
		...
		string ILuaTask<int>.GetException()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void ILuaTask<int>.OnCompleted(System.Action continuation)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
