...
namespace TBydFramework.FairyGUI.Editor
{
    ...
    /// 
    /// </summary>
    [CustomEditor(typeof(Runtime.UI.UIPanel))]
    public class UIPanelEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Runtime.UI.UIPanel panel = target as Runtime.UI.UIPanel;
            ...
            Runtime.UI.FitScreen oldFitScreen = (Runtime.UI.FitScreen)fitScreen.enumValueIndex;
            ...
            if (serializedObject.ApplyModifiedProperties())
            {
                ...
                if (!isPrefab)
                {
                    panel.ApplyModifiedProperties(sortingOrder.intValue != oldSortingOrder, (Runtime.UI.FitScreen)fitScreen.enumValueIndex != oldFitScreen);
                }
            }
        }
