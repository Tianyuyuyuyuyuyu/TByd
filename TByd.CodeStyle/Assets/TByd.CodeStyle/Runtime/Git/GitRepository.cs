...
namespace TByd.CodeStyle.Runtime.Git
{
    ...
    public class GitRepository
    {
        ...
        public bool IsManagedHook(string _hookName)
        {
            ...
            try
            {
                var content = File.ReadAllText(GetHookPath(_hookName));
        ...
        public static bool IsGitRepository(string _path)
        {
            ...
            var gitDirPath = Path.Combine(_path, c_GitDirName);
        ...
        public static string GetGitDirectory(string _repositoryPath)
        {
            ...
            var gitDirPath = Path.Combine(_repositoryPath, c_GitDirName);
        ...
        {
            var gitDirPath = GetGitDirectory(_repositoryPath);
            if (string.IsNullOrEmpty(gitDirPath))
                return string.Empty;

            var hooksDirPath = Path.Combine(gitDirPath, c_HooksDirName);
