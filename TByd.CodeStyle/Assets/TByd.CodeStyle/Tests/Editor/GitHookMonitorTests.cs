...
namespace TByd.CodeStyle.Tests.Editor
{
    ...
    public class GitHookMonitorTests
    {
        ...
        {
            // 获取钩子路径
            var commitMsgPath = GitHookMonitor.GetHookPath(GitHookType.k_CommitMsg, m_TestGitHooksDir);
            var preCommitPath = GitHookMonitor.GetHookPath(GitHookType.k_PreCommit, m_TestGitHooksDir);
        ...
        {
            // 检查钩子是否已安装
            var isCommitMsgInstalled = GitHookMonitor.IsHookInstalled(GitHookType.k_CommitMsg, m_TestGitHooksDir);
            var isPreCommitInstalled = GitHookMonitor.IsHookInstalled(GitHookType.k_PreCommit, m_TestGitHooksDir);
        ...
        {
            // 安装钩子
            var result = GitHookMonitor.InstallHook(GitHookType.k_CommitMsg, m_TestGitHooksDir);
        ...
        public void UninstallHook_HookExists_UninstallsHook()
        {
            ...
            // 卸载钩子
            var result = GitHookMonitor.UninstallHook(GitHookType.k_CommitMsg, m_TestGitHooksDir);
