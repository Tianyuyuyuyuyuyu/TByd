...
namespace TBydFramework.Editor.Executors
{
    [InitializeOnLoad]
    public class EditorExecutors
    {
        ...
        public static Runtime.Asynchronous.IAsyncResult RunAsync(Action action)
        {
        ...
        public static Runtime.Asynchronous.IAsyncResult RunAsync(Action<IPromise> action)
        {
            AsyncResult result = new AsyncResult(true);
            DoRunAsync(() =>
            {
