...
namespace TBydFramework.Runtime.Base
{
    ...
    public sealed class TBydFrameworkLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        /// 初始化游戏框架链表类的新实例。
        /// </summary>
        public TBydFrameworkLinkedList()
        {
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new TBydFrameworkException("First is invalid.");
            }
        ...
        public void RemoveLast()
        {
            ...
            if (last == null)
            {
                throw new TBydFrameworkException("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new TBydFrameworkException("Linked list is invalid.");
                }
