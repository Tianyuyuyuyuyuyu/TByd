...
namespace TBydFramework.Runtime.DataStruct
{
    /// <summary>
    /// 类型和名称的组合值。
    /// </summary>
    ...
    public struct TypeNamePair : IEquatable<TypeNamePair>
    {
        ...
        public override string ToString()
        {
            ...
            return string.IsNullOrEmpty(m_Name) ? typeName : $"{typeName}.{m_Name}";
        }
        ...
        {
            return obj is TypeNamePair && Equals((object)(TypeNamePair)obj);
        }
