...
namespace TBydFramework.Runtime.Utilities
{
    public static class FileUtil
    {
        ...
        private static Stream OpenReadInZip(string path)
        {
            ...
            if (path.IndexOf(".obb", StringComparison.OrdinalIgnoreCase) > 0 && log.IsWarnEnabled)
                log.Warn("Unable to read the content in the \".obb\" file, please click the link for help, and enable access to the OBB file. https://github.com/Tianyuyuyuyuyuyu/XFramework/blob/master/docs/faq.md");
#endif
