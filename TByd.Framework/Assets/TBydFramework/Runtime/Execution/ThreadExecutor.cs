...
namespace TBydFramework.Runtime.Execution
{
    public class ThreadExecutor : AbstractExecutor, IThreadExecutor
    {
        ...
        public virtual Asynchronous.IAsyncResult Execute(Action<Asynchronous.IPromise> action)
        {
            AsyncResult result = new AsyncResult(true);
            Executors.RunAsyncNoReturn(() =>
            {
        ...
        public virtual IAsyncResult<TResult> Execute<TResult>(Action<Asynchronous.IPromise<TResult>> action)
        {
            AsyncResult<TResult> result = new AsyncResult<TResult>(true);
            Executors.RunAsyncNoReturn(() =>
            {
