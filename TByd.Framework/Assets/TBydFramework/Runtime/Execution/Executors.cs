...
namespace TBydFramework.Runtime.Execution
{
    public class Executors
    {
        ...
        public static void RunOnMainThread(Action action, Asynchronous.IPromise promise)
        {
            try
            {
                CheckDisposed();
        ...
        public static void RunOnMainThread<TResult>(Func<TResult> func, Asynchronous.IPromise<TResult> promise)
        {
            try
            {
                CheckDisposed();
        ...
        protected static InterceptableEnumerator WrapEnumerator(IEnumerator routine, Asynchronous.IPromise promise)
        {
            ...
            if (promise != null)
            {
                ...
                enumerator.RegisterFinallyBlock(() =>
                {
                    ...
                    {
                        if (promise.GetType().IsSubclassOfGenericTypeDefinition(typeof(Asynchronous.IPromise<>)))
        ...
        public static Asynchronous.IAsyncResult RunOnCoroutine(Func<Asynchronous.IPromise, IEnumerator> func)
        {
            CoroutineResult result = new CoroutineResult();
        ...
        public static IAsyncResult<TResult> RunOnCoroutine<TResult>(Func<Asynchronous.IPromise<TResult>, IEnumerator> func)
        {
        ...
        public static void RunOnCoroutine(IEnumerator routine, Asynchronous.IPromise promise)
        {
            if (disposed)
            {
                promise.SetException(new ObjectDisposedException("Executors"));
        ...
        public static Asynchronous.IAsyncResult RunAsync(Action<Asynchronous.IPromise> action)
        {
            AsyncResult result = new AsyncResult();
            DoRunAsync(() =>
            {
        ...
        public static IAsyncResult<TResult> RunAsync<TResult>(Action<Asynchronous.IPromise<TResult>> action)
        {
            AsyncResult<TResult> result = new AsyncResult<TResult>();
            DoRunAsync(() =>
            {
