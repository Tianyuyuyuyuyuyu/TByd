...
{
    public sealed class Example4_OdinPlayerPrefs
    {
        #region Singleton
        public const string Name = "Example4_OdinPlayerPrefs";
        static Example4_OdinPlayerPrefs()
        {
        ...
        public Example4_OdinPlayerPrefs() { }
