...
namespace TBydFramework.Tests.Editor.Odin.Util.OneKeyChangeRaycastTarget
{
    [CreateAssetMenu(fileName = "OneKeyChangeRaycastTarget", menuName = "CreatScriptableObject/OneKeyChangeRaycastTarget", order = 200)]
