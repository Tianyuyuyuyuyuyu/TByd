...
namespace TBydFramework.Tests.Editor.Odin.Util.OneKeySearchDuplicateFiles
{
    [CreateAssetMenu(fileName = "OneKeySearchDuplicateFiles", menuName = "CreatScriptableObject/OneKeySearchDuplicateFiles", order = 200)]
