...
namespace TBydFramework.LocalizationsForCsv.Editor.Localizations
{
    public static class LocalizationMenuCsv
    {
        private const string XML_OUTPUT_DIR_KEY = "_X_LOCALIZATION_XML_OUTPUT_DIR_KEY";
        private const string CSV_OUTPUT_DIR_KEY = "_X_LOCALIZATION_CSV_OUTPUT_DIR_KEY";
        private const string DEFAULT_OUTPUT_DIR = "Assets";

        private const string XML2CSV_MENU_NAME = "Assets/X/Xml To Csv";
        private const string CSV2XML_MENU_NAME = "Assets/X/Csv To Xml";
